...
- [Sentinel-2 Atmospheric Correction on a Laptop or Azure](/s2-sen2cor/)
This workflow runs Sen2Cor on L1C imagery, stores L2A and NDVI locally or in Azure, and catalogs the results for notebook queries.
